...
public class SortingTestCheck
{
    public static void main(String args[]) throws IOException {
        BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
        while(true) {
            for (int i_1 = 10000; i_1 < 10001; i_1 += 100) {
                for (int i_2 = 1; i_2 < 20; i_2++) {
                    for (int i_3 = 19; i_3 >= 10; i_3--) {
                        //String info = br.readLine();
                        //String[] arr = info.split(" ");

                        /*int k_1 = Integer.parseInt(arr[0]);
                        float k_2 = Float.parseFloat(arr[1]);
                        float k_3 = Float.parseFloat(arr[2]);*/

                        int k_1 = i_1;
                        //System.out.println(k_1);
                        float k_2 = (float) (i_2) / (float) (20);
                        float k_3 = (float) (i_3) / (float) (20);
                        ...
                        int[] value = new int[k_1];
                        value[0] = 1;
                        for (int i = 0; i < k_1 - 1; i++) {
                            if (random.nextFloat() < k_2)
                                value[i + 1] = value[i];
                            else
                                value[i + 1] = value[i] + 1;
                        }
                        value = DoQuickSort(value);
                        while (calSet(value) >= k_3) {
                            int i = random.nextInt(value.length);
                            int j = random.nextInt(value.length);
                            swap(value, i, j);
                        }
